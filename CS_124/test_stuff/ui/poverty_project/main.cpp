...
using std::fstream;
  ...
  // //////////////////start of main////////////////////
    ...
    cout << "<body>\n" <<
            "<form action=\"http://192.168.50.212/thankyou.html\" method=\"GET\">\n";
...
// ****************ABOVE THE POVERTY LINE ACTION HERE**************************
  ...
  // //////////////////end of main////////////////////
    ...
    cout << "<label>Please Enter Your Name</label>\n" <<
  ...
  void askIfTheUserWantsHelp(){
    ...
    cout << "<input type=\"checkbox\" id=\"jobRec\" name=\"jobRec\" value=\"Job Recommendation\">";
    cout << "<label for=\"jobRec\">Job Recommendation</label><br>";
    
    cout << "<input type=\"checkbox\" id=\"rideShare\" name=\"rideShare\" value=\"Ride Sharing\">";
    cout << "<label for=\"rideShare\">Ride Sharing</label><br>";

    cout << "<input type=\"checkbox\" id=\"food\" name=\"food\" value=\"Food\">";
    cout << "<label for=\"food\">Food</label><br>";
...
bool searchForName(string fileName, string name){
  ...
  //   cout << //"<html><head>"
  //           "<title>Financial Support Survey</title>";
